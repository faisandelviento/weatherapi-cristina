        ...
        <main class="h-100">
            <div class="row h-100 mt-3">
                ...
                <div class="col-12 col-md-9 d-flex flex-column justify-content-start align-items-center gap-4">
                    ...
                    <!-- PREVISIÓ HORÀRIA -->
                    <div
                        class="card-previsio-horaria container-fluid  flex-row gap-1 flex-wrap justify-content-between w-100">
                        ...
                        id="contenedorCardsHorarias">
                            ...
                            <div class="card-previsio-per-hores d-nonecard bg-dark bg-gradient">
                                <div class="card-body d-flex flex-column gap-3 align-items-center justify-content-evenly">
                        ...
                        <div id="contenedorGrafico" style="display: none;">
                            ...
                            <button id="saveChartButton" class= "btn btn-outline-secondary">Save Chart</button>
                        </div>
                    </div>
                </div>
            </div>
